// frontend/src/hooks/useStockPrices.js
// Fetches live prices for a list of symbols, auto-refreshes every 15s
...
export function useStockPrices(symbols = []) {
  const [prices, setPrices]   = useState({});   // { SYMBOL: { price, change, changePct, currency, formatted, isUp } }
